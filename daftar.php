...
<body>
	...
	text-decoration: none;">Log Out<img border="0" align="top" src="image/logout.png" width="20" height="20" style="padding:4px;"></a>
			<h2 style="font-family:helvetica;">Sila Isi Maklumat Berkenaan</h2>
		<hr>
		</br>
				<label class="form-label">No. Rujukan</label>
				<input type="text" name="nr" id="norujukan" required="required" autocomplete="off" placeholder="CTH/123/Pek(4)/00"/><br /><br />
				...
				<label class="form-label">Daripada/Kepada</label>
				<input type="text" style="width: 300px;" name="location" id="location" required="required" autocomplete="off" placeholder="Pejabat Pendidikan Daerah Dalat"/><br /><br />
				<input type="radio" required="required" name="jenis" id="masuk" value="masuk"/>Masuk
				<input type="radio" required="required" name="jenis" id="keluar" value="keluar"/>Keluar<br>
