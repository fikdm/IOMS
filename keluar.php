...
<meta charset="utf-8">
 ...
 <link rel="stylesheet" type="text/css" href="css/table.css?sdad">
   <script type="text/javascript" charset="utf8" src="js/jquery.js"></script>
...
<ul class="nav nav-tabs">
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <div>
       <h2 style="font-family:helvetica;">Surat Keluar Hari Terkini</h2>
    <hr>
    </br>
    <div>
      <table id="table_id" class="display" width="100%" cellspacing="0">
        ...
        <?php       
          ...
          $sel_query="SELECT * FROM office WHERE tterima > DATE_SUB(NOW(), INTERVAL 1 DAY) AND jenis = 'keluar' ORDER BY id DESC;";
    ...
    <h2 style="font-family:helvetica;">Surat Keluar Minggu Terkini</h2>
    <hr>
    </br>
    <div>
      <table id="table_id" class="display" width="100%" cellspacing="0">
        ...
        <?php       
          ...
          $count=1;
          //$sel_query="Select * from office ORDER BY id desc;";
          $sel_query="SELECT * FROM office WHERE tterima > DATE_SUB(NOW(), INTERVAL 1 WEEK) AND jenis = 'keluar' ORDER BY id DESC;";
    ...
    <div>
      <table id="table_id" class="display" width="100%" cellspacing="0">
        ...
        <?php       
          ...
          $count=1;
          //$sel_query="Select * from office ORDER BY id desc;";
          $sel_query="SELECT * FROM office WHERE tterima > DATE_SUB(NOW(), INTERVAL 1 MONTH) AND jenis = 'keluar' ORDER BY id DESC;";
